...
function SimpleComponent({ color = 'info' }) {
    return (jsx(DAlert, { color: color, children: "Simple Component" }));
}
...
function Element1() {
    return (jsx(DChip, { color: "secondary", text: "Element 1" }));
}

function Element2() {
    return (jsx(DChip, { color: "primary", text: "Element 2" }));
}

function Element3() {
    return (jsx(DChip, { color: "danger", text: "Element 3" }));
}
