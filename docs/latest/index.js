...
function SimpleComponent({ color = 'info' }) {
    return (jsxRuntime.jsx(uiReact.DAlert, { color: color, children: "Simple Component" }));
}
...
function Element1() {
    return (jsxRuntime.jsx(uiReact.DChip, { color: "secondary", text: "Element 1" }));
}

function Element2() {
    return (jsxRuntime.jsx(uiReact.DChip, { color: "primary", text: "Element 2" }));
}

function Element3() {
    return (jsxRuntime.jsx(uiReact.DChip, { color: "danger", text: "Element 3" }));
}
